...
import { CategoriesRow, ActionType } from '../types/categories.types';
import { getFilteredData, getTabLists } from '../utils/categories.utils';
...
export const useCategories = () => {
  ...
  const handleOpenAction = (user: CategoriesRow, type: ActionType) => {
  ...
  const columns: Column<CategoriesRow>[] = [
    { id: 'sno', label: 'S.No', minWidth: 60, align: 'center', sortable: false },
    {
      id: 'name',
      label: 'Name',
      minWidth: 170,
      format: (_v: unknown, row: CategoriesRow): React.ReactNode => (
        <Link
          component='button'
          variant='body2'
          underline='hover'
