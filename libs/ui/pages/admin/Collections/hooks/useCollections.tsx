...
import { CollectionsRow, ActionType } from '../types/collections.types';
import { getFilteredData, getTabLists } from '../utils/collections.utils';
...
export const useCollections = () => {
  ...
  const handleOpenAction = (user: CollectionsRow, type: ActionType) => {
  ...
  const columns: Column<CollectionsRow>[] = [
    { id: 'sno', label: 'S.No', minWidth: 60, align: 'center', sortable: false },
    {
      ...
      label: 'Name',
      minWidth: 170,
      format: (_v: unknown, row: CollectionsRow): React.ReactNode => (
        <Link
          component='button'
          variant='body2'
          underline='hover'
