...
interface DetailDialogProps {
  ...
  onClose: () => void;
  onOpenAction: (user: CollectionsRow, type: ActionType) => void;
}
            ...
            {detailUser.status === 'pending_approval' && (
              <>
                <Button
                  ...
                  onClick={() => {
                    onOpenAction(detailUser as CollectionsRow, 'reject');
                    onClose();
                  }}
                >
                  Reject
                ...
                <Button
                  ...
                  onClick={() => {
                    onOpenAction(detailUser as CollectionsRow, 'approve');
                    onClose();
                  }}
                >
                  Approve
