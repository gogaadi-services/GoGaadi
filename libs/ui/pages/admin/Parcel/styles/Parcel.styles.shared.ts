...
export const getBaseStyles = (theme: Theme): Record<string, CSSObject> => ({
  container: {
    ...
    background: 'linear-gradient(160deg, #fff7ed 0%, #fafbff 50%, #ffedd5 100%)',
    minHeight: '100vh',
  ...
  pageHeader: {
    ...
    background: 'linear-gradient(135deg, #1c0a00 0%, #7c2d12 30%, #ea580c 65%, #fb923c 100%)',
    ...
    overflow: 'hidden',
    boxShadow:
      '0 24px 64px rgba(234,88,12,0.28), 0 8px 24px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.1)',
    '&::before': {
      content: '""',
      position: 'absolute',
      top: -100, right: -100,
      ...
      borderRadius: '50%',
      background: 'radial-gradient(circle, rgba(253,186,116,0.38) 0%, rgba(251,146,60,0.12) 50%, transparent 70%)',
      animation: 'pc-orb-drift 14s ease-in-out infinite',
      pointerEvents: 'none',
    },
    '&::after': {
      content: '""',
      ...
      animation: 'pc-orb-drift 10s ease-in-out infinite reverse',
      pointerEvents: 'none',
    },
  ...
  headerOrb3: {
    ...
    animation: 'pc-orb-drift 9s ease-in-out 2s infinite',
    pointerEvents: 'none',
  },
  ...
  statValue: {
    ...
    animation: 'pc-counter 0.7s cubic-bezier(0.34,1.56,0.64,1) both',
  ...
  searchField: {
    ...
    '& .MuiOutlinedInput-root': {
      ...
      '& fieldset': { borderColor: 'rgba(234,88,12,0.15)' },
      '&:hover fieldset': { borderColor: 'rgba(234,88,12,0.35)' },
  ...
  selectionIndicator: {
    ...
    animation: 'pc-slide-up 0.55s cubic-bezier(0.34,1.56,0.64,1) both',
  },
});
