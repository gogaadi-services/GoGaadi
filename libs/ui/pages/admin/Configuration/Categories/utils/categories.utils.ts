...
import { CategoriesRow } from '../types/categories.types';

export const getTableData = (list: IAuthUser[]): CategoriesRow[] =>
  list.map((r, i) => ({ ...r, sno: i + 1 }));

export const getFilteredData = (list: IAuthUser[], search: string): CategoriesRow[] => {
