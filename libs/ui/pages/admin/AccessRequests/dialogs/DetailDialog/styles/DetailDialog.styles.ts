...
export const useStyles = makeStyles()(() => ({
  dialogHeader: {
    background: 'linear-gradient(135deg, #3b0764 0%, #7f1d1d 50%, #dc2626 100%)',
    padding: '24px 24px 20px',
    color: '#fff',
  },
  dialogHeaderBadge: { display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 },
  dialogHeaderBadgeIcon: { fontSize: '18px !important', color: '#fca5a5 !important' },
  ...
  dialogHeaderSubtitle: { color: 'rgba(255,255,255,0.75) !important', marginTop: '2px !important' },
  ...
  sectionTitle: { marginBottom: '8px !important' },
  reasonBox: {
    padding: '12px',
