...
interface DetailDialogProps {
  ...
  onClose: () => void;
  onOpenAction: (user: AccessRequestRow, type: ActionType) => void;
}
        ...
        <>
          <Box className={classes.dialogHeader}>
            <Box className={classes.dialogHeaderBadge}>
              <AssignmentIndIcon className={classes.dialogHeaderBadgeIcon} />
              <Typography
                variant='caption'
                fontWeight={700}
            ...
            <Grid container spacing={2} sx={{ mb: 2 }}>
              <Grid size={{ xs: 6 }}>
                <DetailField
                  label='User ID'
                  value={
                    (detailUser as any).customUserId ||
                    genUserId(detailUser.role ?? detailUser.requestedRole ?? 'user', detailUser.id)
                  }
                />
              </Grid>
              <Grid size={{ xs: 6 }}>
            ...
            {detailUser.status === 'pending_approval' && (
              <>
                <Button
                  ...
                  onClick={() => {
                    onOpenAction(detailUser as AccessRequestRow, 'reject');
                    onClose();
                  }}
                >
                  Reject
                ...
                <Button
                  ...
                  onClick={() => {
                    onOpenAction(detailUser as AccessRequestRow, 'approve');
                    onClose();
                  }}
                >
                  Approve
