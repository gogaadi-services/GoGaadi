...
export const getBaseStyles = (theme: Theme): Record<string, CSSObject> => ({
  ...
  statCard3: {
    ...
    '&::before': { background: 'linear-gradient(90deg, #1e3a8a, #1d4ed8)' },
    '&:hover': { boxShadow: '0 18px 48px rgba(29,78,216,0.16), 0 4px 16px rgba(29,78,216,0.08)' },
  },

  statCard4: {
    animation: 'adm-slide-up 0.55s 0.36s ease both',
  ...
  statCard5: {
    animation: 'adm-slide-up 0.55s 0.45s ease both',
  ...
  statCard6: {
    animation: 'adm-slide-up 0.55s 0.54s ease both',
    '&::before': { background: 'linear-gradient(90deg, #0c4a6e, #0f766e)' },
    '&:hover': { boxShadow: '0 18px 48px rgba(15,118,110,0.16), 0 4px 16px rgba(15,118,110,0.08)' },
  },

  statCard7: {
    animation: 'adm-slide-up 0.55s 0.63s ease both',
  ...
  statCard8: {
    animation: 'adm-slide-up 0.55s 0.72s ease both',
