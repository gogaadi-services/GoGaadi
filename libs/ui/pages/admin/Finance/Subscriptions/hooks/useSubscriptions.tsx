...
import { getFilteredData, getTabLists } from '../utils/subscriptions.utils';
...
export const useSubscriptions = () => {
  ...
  const handleOpenAction = (user: SubscriptionsRow, type: ActionType) => {
  ...
  const columns: Column<SubscriptionsRow>[] = [
    { id: 'sno', label: 'S.No', minWidth: 60, align: 'center', sortable: false },
    {
      id: 'name',
      label: 'Name',
      minWidth: 170,
      format: (_v: unknown, row: SubscriptionsRow): React.ReactNode => (
        <Link
          component='button'
          variant='body2'
          underline='hover'
