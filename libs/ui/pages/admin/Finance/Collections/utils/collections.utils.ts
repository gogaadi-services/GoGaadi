...
import { CollectionsRow } from '../types/collections.types';

export const getTableData = (list: IAuthUser[]): CollectionsRow[] =>
  list.map((r, i) => ({ ...r, sno: i + 1 }));

export const getFilteredData = (list: IAuthUser[], search: string): CollectionsRow[] => {
